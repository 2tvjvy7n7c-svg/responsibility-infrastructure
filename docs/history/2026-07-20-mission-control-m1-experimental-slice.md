...
**Milestone ID:** **M1**  
**Date recorded publicly:** 2026-07-20  
...
**Related internal work:** Doghouse Mission-Control M1 (`MISSION_CONTROL_LOOP_RC1`)  
**Successor:** M2 (reserved; not started; not authorized by M1 closeout)  
...
- The scoped architecture for M1 (authority foundation, request governance, ledger-derived state, lifecycle enforcement, and scheduled multi-mission consume under a supervisor tick) is recorded as **complete**.  
...
Full phase reports, hostile-review packages, evidence custody, and the M1 final completion report are maintained in **internal Doghouse engineering and audit paths** under the company operating system / audit trees. Those records remain internal because they contain implementation and security-relevant detail inappropriate for a public research repository.
